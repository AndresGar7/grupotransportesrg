...
window.onload = function() {
        ...
        // Al cargar la página, se establece la opacidad a 1 para hacer visible el fondo
...
<template>
    ...
    <div class="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] dark:bg-[url('/img/diamond-sunset.svg')] lg:justify-center lg:p-8">
        ...
        <div id="hero-section" class="relative w-full h-screen opacity-0 transition-opacity duration-[3000ms] ease-in-out" style="background-image: url('/img/welcome.jpg'); background-size: cover; background-position: center;">
            <!-- Mensajes estáticos a la izquierda -->
            <div class="absolute left-0 top-1/2 transform -translate-y-1/2 p-6 space-y-4 text-white z-10">
                <h2 class="text-6xl text-red-500 font-bold">¡Bienvenido a nuestro sitio!</h2>
                <p class="text-lg">Ofrecemos lo mejor en calidad y servicio.</p>
