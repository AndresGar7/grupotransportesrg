...
<template>
    ...
    <div class="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] dark:bg-[url('/img/diamond-sunset.svg')] lg:justify-center lg:p-8">
        <header class="w-full fixed top-0 left-0 z-50 mb-6">
            ...
            <!-- Menú fijo -->
            <nav class="sticky top-0 z-50 bg-white shadow-md dark:bg-[#2a2a2a]">
                <div class="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
                    <a href="/" class="block w-14 h-14">
                        <img src="/img/logo.svg" alt="Logo" class="w-full h-full object-contain" />
                    </a>
                    <div class="border-l-2 h-6 mx-4 border-white"></div>
        ...
        <div class="duration-750 starting:opacity-0 flex w-full items-center justify-center opacity-100 transition-opacity lg:grow">
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-6xl lg:flex-row">
                <div
